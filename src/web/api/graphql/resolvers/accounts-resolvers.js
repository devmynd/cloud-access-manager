...
export async function auditService (args: { serviceId: string, skipCache?: boolean }) {
  const serviceAccounts = await serviceManager.getAccountsForService(args.serviceId, args.skipCache || false)
